 ...
 *  @generated
 */
package research.EncodingTutorial.thrift.schema;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.16.0)", date = "2022-09-15")
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFavoriteNumber(), other.isSetFavoriteNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFavoriteNumber()) {
